C FILE: GNSSSNRTDB.F
     ...
     . iprn_array, elev_array, azimuth_array, tod_array,
     . s1_array, s2_array, s5_array, s6_array, s7_array,
     . s8_array)
      implicit none
...
Cf2py intent(out) iprn_array
Cf2py intent(out) elev_array
Cf2py intent(out) azimuth_array
Cf2py intent(out) tod_array
Cf2py intent(out) s1_array
Cf2py intent(out) s2_array
Cf2py intent(out) s5_array
Cf2py intent(out) s6_array
Cf2py intent(out) s7_array
Cf2py intent(out) s8_array
...
c     character*2  key(maxsat)
     ...
     .  iymd(3), nepochs, FirstWeek, idec, z
     ...
     .  t9(9), x9(9), y9(9), z9(9), sp3_rel_secs(np)
      ...
      real*8, dimension(100000) :: elev_array, azimuth_array,
     . tod_array, s1_array, s2_array, s5_array, s6_array,
     . s7_array, s8_array, tod2_array
      integer, dimension(100000) :: iprn_array
...
c                call write_gnss_to_file(fileOUT, iprn, tod,
c     .          s1,s2,s5,azimuth, elev,edot,prn_pick,s6,s7,s8,tod2)
                z = z + 1
                iprn_array(z)=iprn
                elev_array(z)=elev
                azimuth_array(z)=azimuth
                tod_array(z)=tod
                s1_array(z)=s1
                s2_array(z)=s2
                s5_array(z)=s5
