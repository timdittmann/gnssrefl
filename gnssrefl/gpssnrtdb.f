...
c change to 132 characters for inputs
     ...
     . tod_array, s1_array, s2_array, s5_array
...
c                call write_to_file(fileOUT, prn_pick, iprn,
c     .           elev,azimuth, tod, s1,s2, s5)
                z = npts + 1
                iprn_array(z)=iprn
                elev_array(z)=elev
